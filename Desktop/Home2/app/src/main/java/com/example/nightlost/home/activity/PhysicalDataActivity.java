...
public class PhysicalDataActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webview = (WebView) findViewById(R.id.physical_webview);
        probar = (ProgressBar) findViewById(R.id.physical_progressBar);
        ...
        //加载数据
        String url = "http://119.23.21.21/ywapp/index.php/mobile/html/physical";
    ...
    private void loadWebview(String url, Map<String, String> params) {
        OkHttp.postAsync(url, params, new OkHttp.DataCallBack() {
            ...
            public void requestFailure(Request request, IOException e) {
                ...
                Toast.makeText(PhysicalDataActivity.this, "数据请求失败", Toast.LENGTH_SHORT).show();
            }
            ...
            public void requestSuccess(String result) throws Exception {
                ...
                Toast.makeText(PhysicalDataActivity.this, msg, Toast.LENGTH_SHORT).show();
                Log.d(TAG, msg);
